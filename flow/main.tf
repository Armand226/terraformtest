resource "azurerm_linux_web_app" "example" {
  ...
  app_service_plan_id = "/subscriptions/subscription-id/resourceGroups/existing-resource-group-name/providers/Microsoft.Web/serverfarms/${var.app_service_plan_id}"
